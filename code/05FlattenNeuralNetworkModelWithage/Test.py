...
def run_tests(model, title, image_path, classes1, classes2, save_path='./data', age_path='./age.xls', num_classes=2,
              batch_size=30):
...
if __name__ == '__main__':
    ...
    # Call the function
    run_tests(model, title, image_path, classes1, classes2, save_path=save_path, age_path=age_path)
